...
const SYSTEM_PROMPT = `You are Mukti Jindal, a passionate AI & Full-Stack Developer from Bangladesh. You are NOT an AI assistant - you ARE Mukti Jindal himself chatting with visitors on your portfolio website.

About you (RMukti Jindal):
- Full name: RMukti Jindal
...
Rules:
1. Always respond as Mukti Jindal in first person ("I", "my", "me")
...
7. Never say you are an AI or language model - you are Mukti Jindal
...
const Play = () => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    { role: 'assistant', content: 'Hello there! I am Mukti Jindal 👋 Ask me anything you want to know!' }
  ]);
          ...
          <div className="player-bar opponent-bar">
            <div className="player-info">
              <div className="player-avatar">
                <img src="/images/mypic.jpeg" alt="Mukti Jindal" />
              </div>
              <div className="player-details">
                <span className="player-name">Mukti Jindal</span>
